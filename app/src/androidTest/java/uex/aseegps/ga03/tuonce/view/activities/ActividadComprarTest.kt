...
class ActividadComprarTest {
    ...
    fun actividadComprarTest() {
        ...
        appCompatEditText.perform(replaceText("testComprar"), closeSoftKeyboard())
        ...
        val textView2 = onView(
            allOf(
                withId(R.id.tvHaComprado), withText(" ha comprado a "),
                withParent(withParent(withId(R.id.cvNoticiaActividadComprar))),
                isDisplayed()
            )
        )
        textView2.check(matches(withText(" ha comprado a ")))
    }
